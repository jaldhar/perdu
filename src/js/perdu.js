...
//     var view = (function() {
//         var _codes  = { 32: 'pause', 37: 'left', 39: 'right', 38: 'forward'};
...
//         var _drawBackground = function(ctx) {
//             ctx.save();
//             ctx.beginPath();
//             ctx.moveTo(0,0);
//             ctx.lineTo(1200,0);
...
//             _onKeyCallback(state, val);
//             e.preventDefault && e.preventDefault();
//             e.stopPropagation && e.stopPropagation();
//         };

//         var _setOnKeyCallback = function(callback) {
//             _onKeyCallback = callback;
//         };

//         return {
//             init: _init,
//             setOnKeyCallback: _setOnKeyCallback,
//         };
//     })();
...
//         var _model = null;
//         var _view = null;
//         var _states = { 'pause': false, 'left': false, 'right': false,
//             'forward': false};

//         var _init = function(model, view) {
//             this._model = model;
//             this._view = view;
//             this._view.setOnKeyCallback(_onKey.bind(this));
//         };

//         var _onKey = function(state, val) {
//             _states[state] = val;
//         };
